...
public class UserDataInsertTest {
    ...
    void insertTestUsers() {
        ...
        User user_JS0263 = User.builder()
                ...
                .updater("admin")
                .build();
        userRepository.save(user_JS0263);

        User user_JS0266 = User.builder()
                .userId("JS0266")
                .deptId("DA04")
                .name("周仲山")
                .userTypeId(12L)
                ...
                .updater("admin")
                .build();
        userRepository.save(user_JS0266);
        ...
        User user_JS0426 = User.builder()
                ...
                .updater("admin")
                .build();
        userRepository.save(user_JS0426);
        ...
        User user_JS1926 = User.builder()
                ...
                .updater("admin")
                .build();
        userRepository.save(user_JS1926);
        ...
        User user_JS0226 = User.builder()
                ...
                .updater("admin")
                .build();
        userRepository.save(user_JS0226);
        ...
        User user_SH726 = User.builder()
                ...
                .updater("admin")
                .build();
        userRepository.save(user_SH726);
    }
}